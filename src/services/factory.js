...
async function initializeMongoService() {
    ...
    try {
        ...
        const { default: ProductDaoMongo } = await import("./dao/Mongo/product.service.js")
        productService = new ProductDaoMongo()

        const { default: CartDaoMongo } = await import("./dao/Mongo/cart.service.js")
        cartService = new CartDaoMongo()

        const { default: TicketDaoMongo } = await import("./dao/Mongo/ticket.service.js")
